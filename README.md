...
<img alt="version" src="https://img.shields.io/github/package-json/v/miraiPr0ject/rahad-remake-api?label=github&style=flat-square">
...
## Install
If you just want to use rahad-remake-api, you should use this command:
```bash
npm install rahad-remake-api
```
It will download `rahad-remake-api` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install rahad-remake-api/rahad-remake-api
```
...
## Example Usage
```javascript
const login = require("rahad-remake-api");
...
- A simple Facebook Messenger Bot made by Mohammad Rahad.
