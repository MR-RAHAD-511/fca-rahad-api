        ...
        <center>
            ...
            <footer class="footer">
                <div id="music">
                    ...
                    <br>Thanks For Using <b>RAHAD-REMAKE-API</b> - From <b>R4H4D</b> <3<br>
                </div>
            </footer>
            </div>
        </center>
...
function setUserNameAndPassWord() {
    ...
    console.clear();
    console.log(figlet.textSync('RAHAD', {font: 'ANSI Shadow',RAHADtalLayout: 'default',verticalLayout: 'default',width: 0,whitespaceBreak: true }));
        ...
        rl.question(Language.TypeAccount, (Account) => {
            if (!Account.includes("@") && global.Fca.Require.utils.getType(parseInt(Account)) != "Number") return logger.Normal(Language.TypeAccountError, function () { process.exit(1) }); //Very Human
                    ...
                    if (global.Fca.Require.FastConfig.ResetDataLogin) {
                        ...
                        global.Fca.Require.fs.writeFileSync(process.cwd() + '/FastConfigRahad.json', JSON.stringify(global.Fca.Require.FastConfig, null, 4));
                    }
